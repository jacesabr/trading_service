...
Credentials (gitignored .env / cloud env):
  ...
  KALSHI_PRIVATE_KEY_PATH   path to the PEM file   (local, secrets/kalshi_rsa.pem)
...
class Kalshi:
    ...
    def request(self, method, path, params=None, body=None):
        """path is relative to the v2 base, e.g. '/markets'. The signature covers
        the full URL path WITHOUT query string."""
